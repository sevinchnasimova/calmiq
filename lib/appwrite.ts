...
export const SLEEP_COLLECTION_ID = process.env.EXPO_PUBLIC_SLEEP_COLLECTION_ID!;
export const MOOD_COLLECTION_ID = process.env.EXPO_PUBLIC_MOOD_COLLECTION_ID!;
